...
- _NB: Pour exécuter le backend, un fichier d'environnement avec les données de connexion d'une BdD valide est nécessaire. Un modèle se trouve dans `backend/.env.sample`_
...
- déploiements ? Compatible avec Netlify/Vercel/Heroku ?
