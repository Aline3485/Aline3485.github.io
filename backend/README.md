...
6. Go to `localhost:5008` with your favorite browser.
...
- Home page: [GET localhost:5008/](localhost:5008/)
- Item browse: [GET localhost:5008/items](localhost:5008/items)
- Item read: [GET localhost:5008/items/:id](localhost:5008/items/2)
- Item edit: PUT localhost:5008/items/:id
- Item add: POST localhost:5008/items
- Item deletion: DELETE localhost:5008/items/:id
